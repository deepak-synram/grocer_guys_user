...
import 'package:user/providergrocery/searchproviderbean.dart';
...
print(searchData.length);
      ...
      if(!state.isSearching && searchData.isNotEmpty){
          ...
          SharedPreferences.getInstance().then((prefs){
            ...
            Client().post(searchByStoreUri, body: {
              ...
              if (value.statusCode == 200) {
                SearchModelBean pData = SearchModelBean.fromJson(jsonDecode(value.body));
                if ('${pData.status}' == '1') {
