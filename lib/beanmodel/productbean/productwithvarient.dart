...
//     return ProductVarient(json['id'], json['stock'], json['varient_id'], json['description'], json['price'], json['mrp'], '$imagebaseUrl${json['varient_image']}', json['unit'], json['quantity'], json['deal_price'], json['valid_from'], json['valid_to']);
//   }
//
//   @override
//   dynamic toString() {
...
class SearchModelBean{
  dynamic status;
  dynamic message;
  List<ProductDataModel> data;

  SearchModelBean({this.status, this.message, this.data});

  SearchModelBean.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class ProductModel {
  ...
  ProductModel({this.status, this.message, this.totalcount, this.data});

  ProductModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    totalcount = (json['count']!=null)?int.parse('${json['count']}'):0;
    if (json['data'] != null) {
      data = [];
      json['data'].forEach((v) {
  ...
  @override
  String toString() {
    return 'ProductModel{status: $status, message: $message, totalcount: $totalcount, data: $data}';
  }
}
