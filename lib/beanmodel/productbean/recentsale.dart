...
class RecentSaleDataModel{
  ...
  factory RecentSaleDataModel.fromJson(dynamic json){
    return RecentSaleDataModel(json['id'], json['stock'], json['varient_id'], json['product_id'], json['product_name'], '$imagebaseUrl${json['product_image']}', json['description'], json['price'], json['mrp'], '$imagebaseUrl${json['varient_image']}', json['unit'], json['quantity'], json['count']);
  }
