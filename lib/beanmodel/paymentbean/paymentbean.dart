class PaymentMain{
  ...
  PaymentMain(this.status, this.message, this.razorpay, this.paypal,
      this.stripe, this.paystack,this.paytmBean);
  ...
  factory PaymentMain.fromJson(dynamic json){
    ...
    PaytmBean paytmBeanF = PaytmBean.fromJson(json['paytm']);
    return PaymentMain(json['status'], json['message'], razorPayBean, paypalBean, stripeBean, paystackBean,paytmBeanF);
  }

  @override
  String toString() {
    return '{status: $status, message: $message, razorpay: $razorpay, paypal: $paypal, stripe: $stripe, paystack: $paystack, paytmBean: $paytmBean}';
  }
}
...
class PaytmBean{
  dynamic paytm_status;
  dynamic paytm_merchant_id;
  dynamic paytm_merchant_key;

  PaytmBean(this.paytm_status, this.paytm_merchant_id, this.paytm_merchant_key);

  factory PaytmBean.fromJson(dynamic json){
    return PaytmBean(json['paytm_status'], json['paytm_merchant_id'], json['paytm_merchant_key']);
  }

  @override
  String toString() {
    return '{paytm_status: $paytm_status, paytm_merchant_id: $paytm_merchant_id, paytm_merchant_key: $paytm_merchant_key}';
  }
}