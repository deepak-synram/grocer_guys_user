...
import 'package:user/Theme/constantf.dart';
...
import 'package:user/beanmodel/walletbean/walletmodel.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Visibility(
                            visible:
                            (paytmBean != null &&
                                '${paytmBean.paytm_status}'.toUpperCase() ==
                                    'YES'),
                            child: buildPaymentType(
                                Container(
                                  height: 30,
                              ...
                              if (!isLoading) {
                                ...
                                generateSignature('${paytmBean.paytm_merchant_id}', double.parse('${rechargeController.text}'),
                                    '$paymentCurrency', context, '${paytmBean.paytm_merchant_key}');
                              }
                            }),
                          ),
                          Visibility(
  ...
  void getPaytmInit(
    ...
    client
      ...
      if ('${pBean.body.resultInfo.resultCode}' == '0000') {
        ...
        Toast.show('Something went wrong, please try again later.', context,duration: Toast.LENGTH_SHORT,gravity: Toast.LENGTH_SHORT);
        setState(() {
          isLoading = false;
        });
      }
  ...
  void checkOrderStatus(dynamic signature, dynamic restBody,
    ...
    http
      ...
      if ('${orderStatus.body.resultInfo.resultCode}' == '01') {
        checkOut('${rechargeController.text}', 'success', '${orderStatus.body.orderId}', 'paytm');
      } else {
        setState(() {
          isLoading = false;
        });
