...
import 'package:user/beanmodel/mapsection/googlemapkey.dart';
import 'package:user/beanmodel/mapsection/mapboxbean.dart';
import 'package:user/beanmodel/mapsection/mapbybean.dart';
  ...
  void _getLocation() async {
    ...
    if (permission == LocationPermission.whileInUse ||
      ...
      if (isLocationServiceEnableds) {
        ...
        final CameraPosition _kLake = CameraPosition(target: LatLng(position.latitude, position.longitude), zoom: 19.15);
  ...
  void _getCameraMoveLocation(LatLng data) async {
    Timer(Duration(seconds: 1), () async {
      await Geocoder.local
          ...
          .then((value) {
        setState(() {
          currentAddress = value.first.addressLine;
          address = value.first;
        });
      });
    });
