...
import 'package:user/beanmodel/cart/timeslotbeannew.dart';
  ...
  void hitDateCounter(date) async {
    ...
    http.post(timeSlotUri, body: {
      ...
      if (value != null && value.statusCode == 200) {
        TimeSlotNewBean timebean = TimeSlotNewBean.fromJson(jsonDecode(value.body));
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: isFetchingTime
                                  ...
                                  : (radioList!=null && radioList.length>0)
                                  ?ListView.builder(
                                      primary: false,
                                      scrollDirection: Axis.vertical,
                                      shrinkWrap: true,
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    '${radioList[index].availibility}' ==
                                                        ...
                                                        ? Row(
                                                            children: [
                                                              Text((deliveryFee!=null && double.parse('$deliveryFee')>0)?'$apcurrency $deliveryFee':locale.do8,
                                                                  textAlign:
                                                                      TextAlign
                                                                          .left,
                                                                  style: TextStyle(
                                  ...
                                  :Padding(
                                        ...
                                        child: Text('No time slots present for selected date',textAlign: TextAlign.center,),
                                      )),
                          Visibility(
                            visible: isOpenMenu,
                            child: Column(
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text('- $apcurrency ${(promocodeprice).toStringAsFixed(2)}',
                                                        style: TextStyle(
                                                            fontWeight: FontWeight.normal,
                                                            color: kMainTextColor,
                                                            letterSpacing: 1.5,
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text('$apcurrency ${(deliveryFee).toStringAsFixed(2)}',
                                                        style: TextStyle(
                                                            fontWeight: FontWeight.normal,
                                                            color: kMainTextColor,
                                                            letterSpacing: 1.5,
